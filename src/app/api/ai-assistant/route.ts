...
export async function POST(req: NextRequest) {
  ...
  if (geminiApiKey && !geminiApiKey.includes("dummy")) {
    try {
      ...
      console.warn("Gemini API generation failed, falling back to local Ido AI engine:", err.message);
    }
  }

  // Fallback Local Ido AI Generation Engine
  ...
  return apiSuccess({ reply: fallbackReply, mode }, "Ido AI response generated successfully");
}
...
function generateFallbackAIResponse(
  ...
  switch (mode) {
    case "code_review":
      return `### 👩‍💻 Ido AI Code Review (${language || "Code"})
...
\`\`\``;
    ...
    case "time_complexity":
      return `### ⏱️ Ido AI Time Complexity Analysis
...
| 2 | 4 | 1 | 7 | 2 | Match Found! | \`[0, 1]\` |`;
    ...
    case "bug_finder":
      return `### 🐛 Ido AI Bug Scanner & Fixes
...
Hi! I am **Ido AI**, your official intelligent coding mentor at CampusCode.
